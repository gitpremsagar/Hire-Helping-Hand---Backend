...
export const SERVICE_SUBCATEGORY_TO_CATEGORY: Record<
  ServiceSubCategoryEnum,
  ServiceCategoryEnum
> = {
  // Programming & Tech
...
export const SERVICE_CATEGORY_ORDER: ServiceCategoryEnum[] = [
...
export const SERVICE_CATEGORY_METADATA: Record<ServiceCategoryEnum, ServiceCategoryMeta> = {
...
export const SERVICE_SUBCATEGORY_METADATA: Record<ServiceSubCategoryEnum, ServiceSubCategoryMeta> =
  {
    WEB_DEVELOPMENT: {
...
export function isValidServiceCategory(value: string): value is ServiceCategoryEnum {
  return Object.values(ServiceCategoryEnum).includes(value as ServiceCategoryEnum);
}

export function isValidServiceSubCategory(value: string): value is ServiceSubCategoryEnum {
  return Object.values(ServiceSubCategoryEnum).includes(value as ServiceSubCategoryEnum);
}

export function categoryAndSubcategoryMatch(
  category: ServiceCategoryEnum,
  subcategory: ServiceSubCategoryEnum
): boolean {
...
export function getSubcategoriesForCategory(
  ...
  return (Object.keys(SERVICE_SUBCATEGORY_TO_CATEGORY) as ServiceSubCategoryEnum[]).filter(
    (s) => SERVICE_SUBCATEGORY_TO_CATEGORY[s] === category
  );
}

export function subcategoriesOrderedForCategory(
  category: ServiceCategoryEnum
): ServiceSubCategoryEnum[] {
  return getSubcategoriesForCategory(category).sort(
    (a, b) =>
      SERVICE_SUBCATEGORY_METADATA[a].orderNumber - SERVICE_SUBCATEGORY_METADATA[b].orderNumber
  );
}

export function categorySummary(cat: ServiceCategoryEnum) {
...
export function subcategorySummary(sub: ServiceSubCategoryEnum) {
...
export function enrichCategoryFields<
  T extends { serviceCategory: ServiceCategoryEnum; serviceSubCategory: ServiceSubCategoryEnum },
>(row: T) {
  return {
    ...row,
...
export function buildServiceCategoryApiRow(
  cat: ServiceCategoryEnum,
  counts: { freelancing: number; jobs: number }
) {
  const m = SERVICE_CATEGORY_METADATA[cat];
...
export function findCategoryBySlug(slug: string): ServiceCategoryEnum | undefined {
  return SERVICE_CATEGORY_ORDER.find(
    (c) => SERVICE_CATEGORY_METADATA[c].slug.toLowerCase() === slug.toLowerCase()
  );
}

export function findSubcategoryBySlug(slug: string): ServiceSubCategoryEnum | undefined {
  return (Object.keys(SERVICE_SUBCATEGORY_METADATA) as ServiceSubCategoryEnum[]).find(
    (s) => SERVICE_SUBCATEGORY_METADATA[s].slug.toLowerCase() === slug.toLowerCase()
  );
}
