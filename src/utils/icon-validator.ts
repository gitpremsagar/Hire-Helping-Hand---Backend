 ...
 */
export const validateLucideIcon = (iconName: string): boolean => {
 ...
 */
export const getRecommendedIcons = (categoryType: string): string[] => {
 ...
 */
export const sanitizeIconName = (iconName: string): string | null => {
