...
import {
  adminApproveFreelancingService,
  adminRejectFreelancingService,
} from "./admin.freelancingService.controllers.js";
...
adminFreelancingServices.patch(
  "/:id/approve",
  authenticate,
  requireAdmin,
...
adminFreelancingServices.patch(
  ...
  requireAdmin,
  validateFreelancingServiceId,
  validateRejectFreelancingServiceJson,
  adminRejectFreelancingService
);
