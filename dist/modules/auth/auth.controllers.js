...
const generateAccessToken = (userId) => {
    try {
        ...
        return jwt.sign({ userId, type: "access" }, appConfig.jwt.accessToken.secret, { expiresIn: appConfig.jwt.accessToken.expiresIn });
    }
    catch (error) {
...
export const refreshToken = async (req, res) => {
    try {
        ...
        let decoded;
        try {
            decoded = jwt.verify(refreshToken, appConfig.jwt.refreshToken.secret);
        }
        catch (error) {
...
export const resetPassword = async (req, res) => {
    try {
        ...
        let decoded;
        try {
            decoded = jwt.verify(token, appConfig.jwt.passwordResetToken.secret);
        }
        catch (error) {
...
export const verifyEmail = async (req, res) => {
    try {
        ...
        let decoded;
        try {
            decoded = jwt.verify(token, appConfig.jwt.emailVerificationToken.secret);
        }
        catch (error) {
