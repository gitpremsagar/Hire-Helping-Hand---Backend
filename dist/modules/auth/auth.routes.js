...
import { signUp, login, adminLogin, logout, refreshToken, forgotPassword, resetPassword, verifyEmail, verifyPhone, addRoleToUser, removeRoleFromUser } from "./auth.controllers.js";
...
authRoutes.post("/admin/log-in", validateLoginJson, adminLogin);
