...
export const adminApproveFreelancingService = async (req, res) => {
    try {
...
export const adminRejectFreelancingService = async (req, res) => {
    try {
        const { id } = req.validatedParams;
...
//# sourceMappingURL=admin.freelancingService.controllers.js.map