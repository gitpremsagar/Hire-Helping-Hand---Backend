...
export const createUserLanguage = async (req, res) => {
    try {
...
export const getUserLanguageById = async (req, res) => {
    try {
...
export const deleteUserLanguage = async (req, res) => {
    try {
        ...
        if (relationCount > 0) {
            throw new AppError("Cannot delete user language that has related user associations. Please remove all related user associations first.", 400);
        }
...
//# sourceMappingURL=userLanguage.controllers.js.map