...
import { getFreelancers, getFreelancer, createFreelancer, updateFreelancer, deleteFreelancer, getFreelancerProfile, createOrUpdateFreelancerProfile, getFreelancerPortfolio, addPortfolioItem, updatePortfolioItem, deletePortfolioItem, getFreelancerEmployment, addEmployment, updateEmployment, deleteEmployment, getFreelancerEducation, addEducation, updateEducation, deleteEducation, getFreelancerCertifications, addCertification, updateCertification, deleteCertification, } from "./freelancer.controllers.js";
import { 
// Parameter validation middlewares
validateFreelancerIdParams, validatePortfolioItemParams, validateEmploymentParams, validateEducationParams, validateCertificationParams, 
// Freelancer profile validation middlewares
validateFreelancerProfileJson, validatePortfolioItemJson, validateUpdatePortfolioItemJson, validateEmploymentJson, validateUpdateEmploymentJson, validateEducationJson, validateUpdateEducationJson, validateCertificationJson, validateUpdateCertificationJson, } from "./freelancer.validation.middlewares.js";
...
//# sourceMappingURL=freelancer.routes.js.map