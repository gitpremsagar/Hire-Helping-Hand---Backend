...
export const updatePortfolioItem = async (req, res) => {
    try {
        const { freelancerId, portfolioItemId } = req.params;
        const { title, description, mediaUrls, projectUrl, serviceCategoryId, serviceSubCategoryId } = req.body;
        ...
        const nextCat = serviceCategoryId ?? existingItem.serviceCategory;
        const nextSub = serviceSubCategoryId ?? existingItem.serviceSubCategory;
...
export const getFreelancerEmployment = async (req, res) => {
    try {
        const { freelancerId } = req.params;
...
export const updateEmployment = async (req, res) => {
    try {
        const { freelancerId, employmentId } = req.params;
        const { company, role, startDate, endDate, description, serviceCategoryId, serviceSubCategoryId } = req.body;
        ...
        const nextEmpCat = serviceCategoryId ?? existingEmployment.serviceCategory;
        const nextEmpSub = serviceSubCategoryId ?? existingEmployment.serviceSubCategory;
...
export const getFreelancerEducation = async (req, res) => {
    try {
        const { freelancerId } = req.params;
...
export const updateEducation = async (req, res) => {
    try {
        const { freelancerId, educationId } = req.params;
        const { school, degree, field, startDate, endDate, serviceCategoryId, serviceSubCategoryId } = req.body;
        ...
        const nextEduCat = serviceCategoryId ?? existingEducation.serviceCategory;
        const nextEduSub = serviceSubCategoryId ?? existingEducation.serviceSubCategory;
...
export const getFreelancerCertifications = async (req, res) => {
    try {
        const { freelancerId } = req.params;
...
export const updateCertification = async (req, res) => {
    try {
        ...
        const nextCertCat = serviceCategoryId ?? existingCertification.serviceCategory;
        const nextCertSub = serviceSubCategoryId ?? existingCertification.serviceSubCategory;
...
//# sourceMappingURL=freelancer.controllers.js.map