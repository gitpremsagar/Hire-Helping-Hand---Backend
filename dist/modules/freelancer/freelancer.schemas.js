...
const portfolioItemSchema = refineCategoryPair(z.object({
    title: z.string().min(1, "Title is required").max(100, "Title must be less than 100 characters"),
...
const updatePortfolioItemSchema = refineCategoryPair(z.object({
...
// Employment schemas
const employmentSchema = refineCategoryPair(z.object({
...
const updateEmploymentSchema = refineCategoryPair(z.object({
...
// Education schemas
const educationSchema = refineCategoryPair(z.object({
...
const updateEducationSchema = refineCategoryPair(z.object({
...
const certificationSchema = refineCategoryPair(z.object({
...
const updateCertificationSchema = refineCategoryPair(z.object({
...
//# sourceMappingURL=freelancer.schemas.js.map